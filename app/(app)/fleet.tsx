...
export default function FleetScreen() {
  ...
  return (
    <Screen fab={<Fab label="Thêm" onPress={() => router.push('/(app)/driver-form' as never)} />}>
      ...
      {db.drivers.map((d) => {
        ...
        return (
          <TouchableOpacity key={d.id} activeOpacity={0.8} onPress={() => router.push({ pathname: '/(app)/driver-form', params: { id: d.id } } as never)}>
            <Card>
              <View style={s.head}>
